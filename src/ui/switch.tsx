    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          ...
          'group-data-[size=default]/switch:size-4 group-data-[size=md]/switch:size-4 group-data-[size=sm]/switch:size-3',
          ...
          'group-data-[size=default]/switch:data-[state=checked]:translate-x-[calc(100%+14px)]',
        )}
      />
    </SwitchPrimitive.Root>
  )
